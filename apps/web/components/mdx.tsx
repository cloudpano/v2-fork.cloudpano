...
function a({ href, ...properties }: HTMLProps<HTMLAnchorElement>) {
	if (typeof href !== 'string') throw new TypeError('href is required')

	if (href.startsWith('/')) return <Link href={href} {...properties} />
...
function img(properties: HTMLProps<HTMLImageElement>) {
	if (
