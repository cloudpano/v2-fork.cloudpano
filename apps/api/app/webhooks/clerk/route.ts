...
function handleOrganizationUpdated(data: OrganizationJSON) {
	analytics.groupIdentify({
		groupKey: data.id,
		groupType: 'company',
		distinctId: data.created_by,
...
function handleOrganizationMembershipCreated(data: OrganizationMembershipJSON) {
	analytics.groupIdentify({
...
function handleOrganizationMembershipDeleted(data: OrganizationMembershipJSON) {
